...
def retGenSentences1(languageModel1, probFile1):
    ...
    return (" ".join(sentence1)+".", p11)

def retGenSentences2(languageModel1, languageModel2, probFile1, probFile2):
    unigrams1 = languageModel1[0]
    bigrams1 = languageModel1[1]
    trigrams1 = languageModel1[2]
...
def main1(directory1, probFile1, resultFile):
    #load stopwords
    ...
    for i in range(0,10):
        s1, p11 = retGenSentences1([unigrams1, bigrams1, trigrams1], probFile1)
...
def main2(directory1, directory2, probFile1, probFile2, resultFile):
    #load stopwords
    f1 = open("EnglishStopwords.txt", 'r')
    stpwrds = f1.read()
    stopwords = stpwrds.split("\n")
    ...
    for i in range(0,10):
        s1, s2, p11, p12, p21, p22 = retGenSentences2([unigrams1, bigrams1, trigrams1], [unigrams2, bigrams2, trigrams2], probFile1, probFile2)
        fW.write("Model 1 Sentence: \n")
        fW.write(s1+"\n")
        fW.write("Probability of sentence was generated by model 1"+"("+directory1+")"+":- "+str(p11)+ "\n")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 6:
        ...
        main2(directory1, directory2, probFile1, probFile2, resultFile)
    else:
        directory1 = str(sys.argv[1])
        probFile1 = str(sys.argv[2])
        resultFile = str(sys.argv[3])
        main1(directory1, probFile1, resultFile)
